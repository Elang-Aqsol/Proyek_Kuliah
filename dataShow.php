...
<body>
    <div class="container shadow p-0 bg-white">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#">Toko Arta</a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                <ul class="navbar-nav">
                <li class="nav-item">
                        <a class="nav-link" href="/fuzzy/">Halaman Utama</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="proses.php">Proses Data</a>
                    </li>
            ...
            <table class="table table-striped">
                ...
                while($row = mysqli_fetch_array($queryData)){ ?>
                    <tr>
                        ...
                        <td><?=$row['type_item']?></td>
                        <td><?=$row['value']?></td>
                        <td><button data-toggle="modal" data-target="#editQuartil<?=$row['id']?>" class="btn btn-warning">Edit</button></td>
                    </tr>

                    <!-- Modal Edit -->
                    <div class="modal fade" id="editQuartil<?=$row['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog ">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Edit Data <?=$row['quartil']?> <?= $row['item'].' '.$row['type_item']?></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="editQuartil.php" method="post">
                                <input type="hidden" name="id" value="<?=$row['id']?>">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Jenis Perhitungan:</label>
                                        <select name="type_sale" class="form-control" id="">
                                            <option value="<?=$row['type_calculation']?>" selected><?=$row['type_calculation']?></option>
                                            <option value="Penjualan">Penjualan</option>
                                            <option value="Stock">Stock</option>
                                            <option value="ReStock">ReStock</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Quartil:</label>
                                        <select name="quartil" class="form-control" id="">
                                            <option value="<?=$row['quartil']?>" selected><?=$row['quartil']?></option>
                                            <option value="Q1">Q1</option>
                                            <option value="Q2">Q2</option>
                                            <option value="Q3">Q3</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Nama Barang:</label>
                                        <input type="text" value="<?=$row['item']?>" name="stuff" class="form-control">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Tipe Barang:</label>
                                        <input type="text" value="<?=$row['type_item']?>" name="type_stuff" class="form-control">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Value:</label>
                                        <input type="number" value="<?=$row['value']?>" step="0.01" name="value" class="form-control">
                                    </div>
            ...
            <table class="table table-striped">
                ...
                while($row = mysqli_fetch_array($queryData)){ ?>
                    <tr>
                        ...
                        <td><button class="btn btn-warning" data-toggle="modal" data-target="#editData<?=$row['id']?>">Edit</button></td>
                    </tr>
                    ...
                    <div class="modal fade" id="editData<?=$row['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog ">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Edit Data <?= $row['item'].' '.$row['type_item']?></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="editData.php" method="post">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Nama Kategori:</label>
                                        <input type="text" value="<?=$row['category']?>" name="category" class="form-control">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Stok Awal:</label>
                                        <input type="number" value="<?=$row['first_stock']?>" step="0.01" name="first_stock" class="form-control">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Restock:</label>
                                        <input type="number" value="<?=$row['restock']?>" step="0.01" name="restock" class="form-control">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Penjualan:</label>
                                        <input type="number" value="<?=$row['sale']?>" step="0.01" name="sale" class="form-control">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Stok Akhir:</label>
                                        <input type="number" value="<?=$row['end_stock']?>" step="0.01" name="end_stock" class="form-control">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Satuan:</label>
                                        <input type="text" value="<?=$row['first_unit']?>" name="first_unit" class="form-control">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Harga Restock:</label>
                                        <input type="number" value="<?=$row['restock_price']?>" name="restock_price" class="form-control">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Harga Jual:</label>
                                        <input type="number" value="<?=$row['price_sale']?>" name="price_sale" class="form-control">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Konversi:</label>
                                        <input type="number" value="<?=$row['conversion']?>" name="conversion" class="form-control">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Satuan:</label>
                                        <input type="text" value="<?=$row['second_unit']?>" name="second_unit" class="form-control">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="exampleInputEmail1">Total Jual:</label>
                                        <input type="number" value="<?=$row['total_sales']?>" name="total_sales" class="form-control">
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Keluar</button>
