...
<body>
    <div class="container shadow p-0 bg-white">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="index.php">Toko Arta</a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    ?>
                    <?php } ?>
            <h3><span class="badge badge-primary" style="width: 100%;">Hasil</span></h3>
                    ...
                    ?>
                        <main class="mb-2 col-md-3">
                            <div class="p-2 border mb-3 rounded text-center">
                                <h5><span class="badge badge-light title-data" style="width: 100%;"><?= $dataArrayItem[$x]->item ?></span></h5>

                                <h4 class="m-0 font-weight-bold data" ><?= round($totalTop / $totalBottom) ?></h4>
                            </div>
                        </main>
                    <?php } 
                    ?>
